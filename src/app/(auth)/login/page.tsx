...
function LoginForm() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // If the user arrived via an SMS deep-link, send them straight there
    const redirectTo = searchParams.get('redirectTo')
    router.push(redirectTo && redirectTo.startsWith('/dashboard') ? redirectTo : '/')
    router.refresh()
  }
    ...
    <div className="min-h-screen flex" style={{ background: 'oklch(0.13 0.022 252)' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12"
        ...
        <div className="space-y-4">
          {[
            { icon: '📋', text: 'Scope of Work generated by proprietary software' },
